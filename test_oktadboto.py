...
METADATA = {'access_key': 'ASIA__ACCESSS_KEY__GJON5',
...
class OktadBoto(unittest.TestCase):
    def test_oktad_command(self):
        self.assertEqual(oktad_command('foo_profile'), ['oktad', 'foo_profile', '--', 'env'])
    ...
    def test_get_oktad_credentials(self, mock_datetime, mock_subprocess_run):
        ...
        self.assertDictEqual(METADATA, get_oktad_credentials('bar_profile', timedelta(minutes=30)))
